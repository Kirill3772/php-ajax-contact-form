...
Dynamic Contact Form using AJAX and PHP, including: Cross Browser Support (even old IE browsers), Server Side Input Validation, Error Messages, Email Spam Filter Bypass (tested with gmail and hotmail) and Connection Monitoring.
